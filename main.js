...
{ keyPressed = e.keyCode; 
 ...
 } if(e.shiftKey == true && keyPressed == '77') { console.log("m and shift pressed together"); 
...
{ 
    ...
    { 
        ...
        { 
            player_y = player_y + block_image_height; console.log("block image height = " + block_image_height); 
